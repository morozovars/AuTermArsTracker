...
struct ars_tracker_download_item_t {
    QString remote_file;
    QStringList remote_candidates;
    int remote_candidate_index;
...
private:
    ...
    QStringList build_remote_file_candidates(const QString &filename) const;
